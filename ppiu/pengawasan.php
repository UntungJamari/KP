...
<body id="page-top">
    ...
    <div id="wrapper">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <!-- Card Body -->
                                <div class="card-body">
                                    <a href="blanko_pengawasan_umrah.php" type="button" class="btn btn-outline-info btn-sm mb-3">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <ol style="padding-left: 20px;">
                                                                <li><?php echo $tampil['petugas_1']; ?></li>
                                                                <li><?php echo $tampil['petugas_2']; ?></li>
                                                            </ol>
                                                        </td>
                                                        <td>
                                                            <a id="detail" type="button" class="btn btn-outline-info btn-sm" data-toggle="modal" data-target="#modal-detail" data-id_pengawasan="<?php echo $tampil['id_pengawasan']; ?>" data-hari="<?php echo $tampil['hari']; ?>" data-tanggal="<?php echo $tanggal; ?>" data-jam="<?php echo $tampil['jam']; ?>" data-izin="<?php echo $tampil['izin']; ?>" data-jumlah_jemaah_laki_laki="<?php echo $tampil['jumlah_jemaah_laki_laki']; ?>" data-jumlah_jemaah_wanita="<?php echo $tampil['jumlah_jemaah_wanita']; ?>" data-tanggal_keberangkatan="<?php echo $tanggal_keberangkatan; ?>" data-tanggal_kepulangan="<?php echo $tanggal_kepulangan; ?>" data-temuan_lapangan="<?php echo $tampil['temuan_lapangan']; ?>" data-petugas_1="<?php echo $tampil['petugas_1']; ?>" data-petugas_2="<?php echo $tampil['petugas_2']; ?>">
                                                                <i class="fas fa-fw fa fa-eye"></i>
                                                            </a>
                                                            <a href="edit_isian_blanko_pengawasan.php?id_pengawasan=<?php echo $tampil['id_pengawasan'] ?>" type="button" class="btn btn-outline-warning btn-sm">
                                                                <i class="fas fa-fw fa fa-edit"></i>
                                                            </a>
                                                            <a id="hapus-pengawasan" type="button" class="btn btn-outline-danger btn-sm" data-toggle="modal" data-target="#modal-hapus" data-id_pengawasan="<?php echo $tampil['id_pengawasan']; ?>">
        ...
        <script>
            $(document).on('click', '#hapus-pengawasan', function(e) {
                e.preventDefault();
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        window.location = 'pengawasan.php?hapus_pengawasan=true&id_pengawasan=' + id_pengawasan;
