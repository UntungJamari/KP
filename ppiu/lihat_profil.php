                        ...
                        <div class="col-xl-12 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div class="table-responsive card-body">
                                    ...
                                    $query = mysqli_query($koneksi, "select * from ppiu, kab_kota where ppiu.id_kab_kota=kab_kota.id_kab_kota and ppiu.username='$username'");
                                    $result = mysqli_fetch_assoc($query);

                                    ?>
                                    <center>
                                        <img src="../images/profile/<?php echo $result['logo']; ?>" style="width: 250px;" class="mb-5">
                                        <h4 class="mb-3"><?php echo $result['nama_ppiu']; ?></h4>
                                        <table class="table table-bordered no-margin col-8">
                                            <tbody>
                                                <tr>
                                                    <th style="width: 30%;">ID</th>
                                                    <td><span><?php echo $result['id_ppiu']; ?></span></td>
                                                </tr>
                                                <tr>
                                                    <th>Username</th>
                                                ...
                                                <tr>
                                                    <th>Status</th>
                                                    <td><span><?php echo $result['status']; ?></span></td>
                                                </tr>
                                                <tr>
                                                    <th>Nama Pimpinan</th>
                                                ...
                                                <tr>
                                                    <th>Nomor SK</th>
                                                    <td><span><?php echo $result['nomor_sk']; ?></span></td>
                                                </tr>
                                                <tr>
                                                    <th>Tanggal SK</th>
                                                    <td><span><?php echo $result['tanggal_sk']; ?></span></td>
                                                </tr>
                                                <tr>
                                                    <th>Alamat</th>
