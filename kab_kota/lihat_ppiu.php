...
if ((isset($_GET['hapus_ppiu'])) && (isset($_GET['username']))) {
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a id="hapus-ppiu" type="button" class="btn btn-outline-danger btn-sm" data-toggle="modal" data-target="#modal-hapus" data-username="<?php echo $tampil['username']; ?>">
            ...
            $(document).on('click', '#hapus-ppiu', function(e) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        window.location = 'lihat_ppiu.php?hapus_ppiu=true&username=' + username;
