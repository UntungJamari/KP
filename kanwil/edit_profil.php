...
if (isset($_POST['simpan'])) {
    $id_kanwil = $_POST['id_kanwil'];
    $nama_pimpinan = $_POST['nama_pimpinan'];
    $alamat = $_POST['alamat'];

    $query = mysqli_query($koneksi, "update kanwil set nama_pimpinan = '$nama_pimpinan', alamat = '$alamat' where id_kanwil = $id_kanwil");
    if ($query) {
                        ...
                        <div class="col-xl-12 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    $query = mysqli_query($koneksi, "select * from kanwil where kanwil.username='$username'");
                                    ...
                                    <form class="row g-2" action="edit_profil.php" method="POST">
                                        <input type="hidden" name="id_kanwil" value="<?php echo $result['id_kanwil']; ?>">
                                        <div class="col-md-6 form-group">
                                            <label for="input1" class="form-label">ID</label>
                                            <input type="text" class="form-control" style="background-color: #dee2e6" id="input1" value="<?php echo $result['id_kanwil']; ?>" disabled required>
                                        </div>
                                        <div class="col-md-6 form-group">
