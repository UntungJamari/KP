...
<table id="table1" data-cols-width="4,14,12,12,30,20,10,10,14,14,20,20,20" style="color: white;">
    ...
    <tr>
        <th data-a-h="center" colspan="13">Kanwil kementerian Agama Provinsi Sumatera Barat</th>
    </tr>
    <tr>
    ...
    $query = mysqli_query($koneksi, "select * from pengawasan, ppiu where pengawasan.id_ppiu=ppiu.id_ppiu");
    $no = 1;
...
<script>
    ...
    TableToExcel.convert(document.getElementById("table1"), {
        name: "Blanko Pengawasan Umrah Kanwil Kemenag Sumbar.xlsx",
        sheet: {
            name: "Sheet 1"
        }
    });
