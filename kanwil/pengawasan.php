                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        ...
                                        $query = mysqli_query($koneksi, "select * from pengawasan, ppiu, kab_kota where pengawasan.id_ppiu=ppiu.id_ppiu and ppiu.id_kab_kota=kab_kota.id_kab_kota");
                                        $no = 1;
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a id="detail" type="button" class="btn btn-outline-info btn-sm" data-toggle="modal" data-target="#modal-detail" data-id_pengawasan="<?php echo $tampil['id_pengawasan']; ?>" data-nama_ppiu="<?php echo $tampil['nama_ppiu']; ?>" data-nama_kab_kota="<?php echo $tampil['nama_kab_kota']; ?>" data-hari="<?php echo $tampil['hari']; ?>" data-tanggal="<?php echo $tanggal; ?>" data-jam="<?php echo $tampil['jam']; ?>" data-izin="<?php echo $tampil['izin']; ?>" data-jumlah_jemaah_laki_laki="<?php echo $tampil['jumlah_jemaah_laki_laki']; ?>" data-jumlah_jemaah_wanita="<?php echo $tampil['jumlah_jemaah_wanita']; ?>" data-tanggal_keberangkatan="<?php echo $tanggal_keberangkatan; ?>" data-tanggal_kepulangan="<?php echo $tanggal_kepulangan; ?>" data-temuan_lapangan="<?php echo $tampil['temuan_lapangan']; ?>" data-petugas_1="<?php echo $tampil['petugas_1']; ?>" data-petugas_2="<?php echo $tampil['petugas_2']; ?>">
